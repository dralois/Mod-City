...
public class @InputHandler : IInputActionCollection, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Player"",
            ""id"": ""3f6dfaba-4dea-4e82-9830-5a96e0172d41"",
            ""actions"": [
                {
                    ""name"": ""Jump"",
                    ""type"": ""Button"",
                    ""id"": ""650a484f-328e-47de-bf8e-b7dab93dc9e8"",
                ...
                },
                {
                    ""name"": ""Shoot"",
                    ""type"": ""Button"",
                    ""id"": ""e16b5e3c-f937-4ddf-90a6-b9f9a2c0155b"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""ae736cfd-5bff-4248-ad75-a167f7c7dece"",
                ...
                {
                    ""name"": ""negative"",
                    ""id"": ""b566ab2b-eb14-49be-9081-468aa4eb90ff"",
                ...
                {
                    ""name"": ""positive"",
                    ""id"": ""54308d0d-e437-45d4-a694-be943655e905"",
                ...
                {
                    ""name"": """",
                    ""id"": ""4c8c1da4-9f81-4aad-89b7-15134348a4a5"",
                ...
                {
                    ""name"": """",
                    ""id"": ""81ab0b1d-f825-43ca-9c80-bb2512f230db"",
        ...
        {
            ""name"": ""Level"",
            ""id"": ""8d791465-64b4-4d26-9ad5-13713966f016"",
            ""actions"": [
                {
                    ""name"": ""Cancel"",
                    ""type"": ""Button"",
                    ""id"": ""c79f6493-9557-459d-91b7-83d691f471eb"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """"
                }
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""a1bb9acc-253b-47f8-8d44-45bd1ebe30ec"",
                ...
                {
                    ""name"": """",
                    ""id"": ""1266a50a-131d-42ba-9c9b-0ba6c2b9b893"",
                    ""path"": ""<Gamepad>/start"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        m_Level_Cancel = m_Level.FindAction("Cancel", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Level_Cancel;
    public struct LevelActions
    {
        private @InputHandler m_Wrapper;
        public LevelActions(@InputHandler wrapper) { m_Wrapper = wrapper; }
        public InputAction @Cancel => m_Wrapper.m_Level_Cancel;
        ...
        public void SetCallbacks(ILevelActions instance)
        {
            ...
            {
                @Cancel.started -= m_Wrapper.m_LevelActionsCallbackInterface.OnCancel;
                @Cancel.performed -= m_Wrapper.m_LevelActionsCallbackInterface.OnCancel;
                @Cancel.canceled -= m_Wrapper.m_LevelActionsCallbackInterface.OnCancel;
            }
